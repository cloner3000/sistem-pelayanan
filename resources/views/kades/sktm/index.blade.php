@extends('kades.admin')
@section('judul','Daftar Pengajuan Surat Keterangan Tidak Mampu')
...
@section('isi')
	<section class="content-header">
      ...
      <ol class="breadcrumb">
        ...
        <li class="active">Daftar Pengajuan Surat Keterangan Tidak Mampu</li>
      </ol>
    </section>
    	...
    	<div class="row">
    		<div class="col-xs-12">
	            ...
	            <div class="box-header">
	              <h3 class="box-title">Daftar Pengajuan Surat Keterangan Tidak Mampu</h3>
	            </div>
	              ...
	              <table class="table table-hover">
	                ...
	                @foreach($datas as $data)
			            	<tr>
			                  	...
			                  	<td>
									<a class="btn btn-xs btn-info" data-toggle="modal" data-target="#{{md5($data->id.'sktm')}}" >
					                ...
					                <form id="{{md5($data->id.'acc')}}" action="{{ route('kades.sktm.acc') }}" method="POST" style="display: none;">
					                    {{ csrf_field() }}
