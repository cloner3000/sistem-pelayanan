    		...
    		<div class="col-xs-12">
	           ...
	           <div class="box-header">
						<div class="row">
							...
							<div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
								<form class="navbar-form navbar-form pull-right" method="post" action="{{ route('kades.spp.export') }}">
									{{csrf_field()}}
	                ...
	                @foreach($datas as $data)
			            	<tr>
			                  	...
			                  	<td>
					                ...
					                <form id="{{md5($data->id.'hapus')}}" action="{{ route('kades.spp.destroy',$data->id) }}" method="POST" style="display: none;">
					                    {{ csrf_field() }}
			        ...
			        <div class="modal-content">
			            ...
			            <div class="modal-body">
				            ...
				            <div class="input-group">
				              	...
				              	<select class="form-control" data-url="{{ route('kades.spp.show',['spp'=> $d->id,'user_id' => '']) }}" onchange="getData(this);">
				              		@foreach($user as $u)
			    ...
			    <div class="modal-dialog" role="document">
			        <div class="modal-content">
			            ...
			            <div class="modal-body mx-3">
				             ...
				             <form method="POST" action="{{ route('kades.spp.update',$d->id) }}">
								{{ csrf_field() }}
