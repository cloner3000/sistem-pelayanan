...
@section('isi')
	<section class="content-header">
      ...
      <ol class="breadcrumb">
        ...
        <li class="active">Daftar Kategori Postingan</li>
      </ol>
    </section>
    ...
    <section class="content">
    	...
    	<div class="row">
    		<div class="col-xs-12">
	            ...
	            <div class="box-header">
	              <div class="row">
	              	<div class="col-xs-6">
	              		<h3 class="box-title">Daftar Kategori Postingan</h3>
	              	</div>
	              	<div class="col-xs-6">
	              		<div class="text-right">
			            	<a class="btn btn-xs btn-primary" data-toggle="modal" data-target="#tambah"><i class="fa fa-plus"></i> Tambah</a>
			            </div>
						    ...
						    <div class="modal-dialog" role="document">
						        <div class="modal-content">
						            <div class="modal-header text-center">
						                <h4 class="modal-title w-100 font-weight-bold">Tambah Data Kategori</h4>
	              ...
	              <table class="table table-hover">
	                ...
	                @foreach($datas as $data)
			            	<tr>
			                  	...
			                  	<td>{{$data->slug}}</td>
			                  	<td>
									<a class="btn btn-xs btn-info" data-toggle="modal" data-target="#{{md5($data->id.'kategori')}}" >
    	...
    	@foreach($datas as $d)
			<div class="modal fade" id="{{md5($d->id.'kategori')}}" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
			    <div class="modal-dialog" role="document">
			        <div class="modal-content">
			            <div class="modal-header text-center">
			                <h4 class="modal-title w-100 font-weight-bold">Ubah Data Kategori</h4>
			                <button type="button" class="close" data-dismiss="modal" aria-label="Close">
			                    <span aria-hidden="true">&times;</span>
			                </button>
			            </div>
