    		...
    		<div class="col-xs-12">
	            ...
	            <div class="box-header">
					<div class="row">
						...
						<div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
							<form class="navbar-form navbar-form pull-right" method="post" action="{{ route('kades.pengaduan.export') }}">
								{{csrf_field()}}
	                ...
	                @foreach($datas as $data)
			            	<tr>
								<td>{{++$no}}</td>
			                  	...
			                  	<td>
									<a href="{{ route('kades.pengaduan.show',$data->id) }}" class="btn btn-xs btn-primary">
										<i class="fa fa-eye"></i>
										 Lihat
									</a>
									<br>								
