						    ...
						    <div class="modal-dialog" role="document">
						        <div class="modal-content">
						            ...
						            <div class="modal-body mx-3">
							            ...
							            <form method="POST" action="{{ route('kades.profesi.store') }}">
											{{ csrf_field() }}
			            	...
			            	<tr>
			                  	...
			                  	<td>
									...
									<a class="btn btn-xs btn-danger" onclick="event.preventDefault();document.getElementById('{{md5($data->id."hapus")}}').submit();" style="margin-left: 5px;">
					                    ...
					                    <form id="{{md5($data->id.'hapus')}}" action="{{ route('kades.profesi.destroy',$data->id) }}" method="POST" style="display: none;">
					                        {{ csrf_field() }}
			    ...
			    <div class="modal-dialog" role="document">
			        <div class="modal-content">
			            ...
			            <div class="modal-body mx-3">
				            ...
				            <form method="POST" action="{{ route('kades.profesi.update',$d->id) }}">
								{{ csrf_field() }}
