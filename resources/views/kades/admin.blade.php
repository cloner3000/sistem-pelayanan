...
<div class="wrapper">
  ...
  <header class="main-header">
    <a href="{{ route('kades.dashboard') }}" class="logo">
        ...
        <li class="treeview @yield('sk')">
          ...
          <ul class="treeview-menu">
            <li class="@yield('pengajuanSk')">
              <a href="{{ route('kades.sk.index') }}">
                <i class="fa fa-dot-circle"></i> 
                Pengajuan
              </a>
            </li>
            <li class="@yield('riwayatSk')">
              <a href="{{ route('kades.sk.acc') }}">
                <i class="fa fa-dot-circle"></i> 
                Riwayat Pengajuan
              </a>
            </li>
...
<script type="text/javascript">
    $(function () {
        $('#l_bayi,#l_ibu,#p_ibu,#l_ayah,#p_ayah,#tl,#tl1,#tl2,#tl_anak,#l_pengaduan,#sktm_tl,#l_kematian,#l_kematian_pelapor,#w_kematian').datetimepicker({
