	              ...
	              <table class="table table-hover">
	                ...
	                @foreach($datas as $data)
			            	<tr>
			                  	...
			                  	<td>
									<a class="btn btn-xs btn-info" data-toggle="modal" data-target="#{{md5($data->id.'user')}}" style="margin: 5px;">
										<i class="fa fa-edit"></i>
										 Edit
									</a>
									<a class="btn btn-xs btn-danger" onclick="event.preventDefault();document.getElementById('{{md5($data->id."hapus")}}').submit();"style="margin: 5px;">
