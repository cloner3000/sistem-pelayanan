...
@section('isi')
    ...
    <section class="content">
			        ...
			        <div class="box-header">
						<div class="row">
							<div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
								<h4>Daftar Pengajuan Surat Keterangan Yang Telah Diterima</h4>
							</div>
							<div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
								<form class="navbar-form navbar-form pull-right" method="post" action="{{ route('sk.export') }}">
									{{csrf_field()}}
		              ...
		              <table class="table table-hover">
		                ...
		                @foreach($datas as $data)
				            	<tr>
				                  	...
				                  	<td>
										<a class="btn btn-xs btn-primary" data-toggle="modal" data-target="#{{md5($data->id.'keteranganpdf')}}">
						                ...
						                <form id="{{md5($data->id.'hapus')}}" action="{{ route('sk.destroy',$data->id) }}" method="POST" style="display: none;">
						                    {{ csrf_field() }}
    	...
    	@foreach($datas as $d)
    		<div class="modal fade" id="{{md5($d->id.'keteranganpdf')}}" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
			    ...
			    <div class="modal-dialog modal-lg" role="document">
			        <div class="modal-content">
			            ...
			            <div class="modal-body">
				            ...
				            <form method="POST" action="{{ route('sk.update',$d->id) }}">
								{{ csrf_field() }}
