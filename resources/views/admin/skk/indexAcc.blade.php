    			...
    			<div class="box">
		            ...
		            <div class="box-header">
						<div class="row">
							...
							<div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
								<form class="navbar-form navbar-form pull-right" method="post" action="{{ route('skk.export') }}">
									{{csrf_field()}}
			        ...
			        <div class="modal-content">
			            ...
			            <div class="modal-body">
				            ...
				            <div class="input-group">
				              	...
				              	<select class="form-control" data-url="{{ route('skk.show',['skk'=> $d->id,'user_id' => '']) }}" onchange="getData(this);">
				              		@foreach($user as $u)
