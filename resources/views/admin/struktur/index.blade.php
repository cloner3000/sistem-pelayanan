	              ...
	              <table class="table table-hover">
	                ...
	                @foreach($datas as $data)
			            	<tr>
			                  	...
			                  	<td>{{$data->jabatan}}</td>
			                  	<td>
			                  		<img src="{{ asset('storage/struktur/'.$data->foto) }}" class="img-thumbnail" style="width: 100px;height: auto;">
			                  	</td>
			                  	<td>
			    ...
			    <div class="modal-dialog" role="document">
			        <div class="modal-content">
			            ...
			            <div class="modal-body mx-3">
				            ...
				            <form method="POST" action="{{ route('admin.struktur.update',$d->id) }}" enctype="multipart/form-data">
								{{ csrf_field() }}
