...
class SkController extends Controller
{
    ...
    public function indexAcc(Request $req){
        ...
        if (Auth::user()->roles->first()->name == "Kepala Desa") {
            return view('kades.sk.indexAcc',compact('datas','user'))->with('no',($req->input('page',1)-1)*10);
        }else{
            return view('admin.sk.indexAcc',compact('datas','user'))->with('no',($req->input('page',1)-1)*10);
        }
    }
