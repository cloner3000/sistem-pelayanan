...
class SkController extends Controller
{
    ...
    public function index(Request $req)
    {
        ...
        if (Auth::user()->roles->first()->name == "Kepala Desa") {
            return view('kades.sk.index',compact('datas','ps','nKtp','nPengaduan','nSk','nSkematian','nSkk','nSktm','nSptjm'))->with('no',($req->input('page',1)-1)*10);
        }else{
            return view('admin.sk.index',compact('datas','ps','nKtp','nPengaduan','nSk','nSkematian','nSkk','nSktm','nSptjm'))->with('no',($req->input('page',1)-1)*10);
        }
    }
    ...
    public function indexAcc(Request $req)
    {
        ...
        if (Auth::user()->roles->first()->name == "Kepala Desa") {
            return view('kades.sk.indexAcc',compact('datas','user','export','ps','nKtp','nPengaduan','nSk','nSkematian','nSkk','nSktm','nSptjm'))->with('no',($req->input('page',1)-1)*10);
        }else{
            return view('admin.sk.indexAcc',compact('datas','user','export','ps','nKtp','nPengaduan','nSk','nSkematian','nSkk','nSktm','nSptjm'))->with('no',($req->input('page',1)-1)*10);
        }
    }
    ...
    public function acc(Request $req)
    {
        ...
        if ($data->save()) {
            ...
            session()->flash('pesan','Pengajuan Surat Keterangan berhasil di terima');
        }else{
            session()->flash('status','Gagal');
            session()->flash('pesan','Pengajuan Surat Keterangan gagal di terima');
        }
        return back();
    }
    ...
    public function update(Request $r, $id)
    {
        ...
        if ($data->save()) {
            session()->flash('status','Sukses');
            session()->flash('pesan','Pengajuan Surat Keterangan berhasil di ubah');
        }else{
            session()->flash('status','Gagal');
            session()->flash('pesan','Pengajuan Surat Keterangan gagal di ubah');
        }
        return back();
    }
    ...
    public function destroy($id)
    {
        $data = Sk::findOrFail($id);
         if ($data->delete()) {
            session()->flash('status','Sukses');
            session()->flash('pesan','Pengajuan Surat Keterangan berhasil di hapus');
        }else{
            session()->flash('status','Gagal');
            session()->flash('pesan','Pengajuan Surat Keterangan gagal di hapus');
        }
        return back();
    }
}
