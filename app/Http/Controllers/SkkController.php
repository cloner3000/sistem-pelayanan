...
class SkkController extends Controller
{
    ...
    public function index(Request $req)
    {
        ...
        if (Auth::user()->roles->first()->name == "Kepala Desa") {
            return view('kades.skk.index',compact('datas','ps','nKtp','nPengaduan','nSk','nSkematian','nSkk','nSktm','nSptjm'))->with('no',($req->input('page',1)-1)*10);
        }else{
            return view('admin.skk.index',compact('datas','ps','nKtp','nPengaduan','nSk','nSkematian','nSkk','nSktm','nSptjm'))->with('no',($req->input('page',1)-1)*10);
        }
    }
    ...
    public function indexAcc(Request $req)
    {
        ...
        if (Auth::user()->roles->first()->name == "Kepala Desa") {
            return view('kades.skk.indexAcc',compact('datas','export','user','ps','nKtp','nPengaduan','nSk','nSkematian','nSkk','nSktm','nSptjm'))->with('no',($req->input('page',1)-1)*10);
        }else{
            return view('admin.skk.indexAcc',compact('datas','export','user','ps','nKtp','nPengaduan','nSk','nSkematian','nSkk','nSktm','nSptjm'))->with('no',($req->input('page',1)-1)*10);
        }
    }
